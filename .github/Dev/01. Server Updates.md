...
// Function to check if Java version 21 is installed
        ...
        (error, stdout, stderr) => {
            if (error) {
                ...
                if (versionMatch) {
                    ...
                    // Check if it's JDK 8 or below and handle appropriately
                    if (versionString == '1') {
                        callback(`[x] Wrong Java Version Installed, Detected Version "${javaVersion}"`, CONSTANTS.logStatus.FAIL);
                    } else {
                        // check if its JDK 9 or above
